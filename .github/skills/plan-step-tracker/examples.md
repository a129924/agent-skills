...
```bash
$ python scripts/step_tracker.py check_all_succeeded my-feature-complete
...
```bash
$ python scripts/step_tracker.py read_all empty-topic
# (empty output)

$ python scripts/step_tracker.py read_not_run empty-topic
# (empty output)

$ python scripts/step_tracker.py check_all_succeeded empty-topic
...
```bash
$ python scripts/step_tracker.py read_all nonexistent-topic
...
```bash
$ python scripts/step_tracker.py read_all no-checkboxes
# (empty output)

$ python scripts/step_tracker.py check_all_succeeded no-checkboxes
✅ SUCCESS: All 0 steps complete
```
...
# Fetch pending steps
PENDING=$(python scripts/step_tracker.py read_not_run "$TOPIC")
...
python scripts/step_tracker.py check_all_succeeded "$TOPIC"
CHECK_EXIT=$?
