...
6. Create `skills/<skill-name>/` as the canonical authoring target for transition work, where `<skill-name>` must use lowercase kebab-case.
...
# Outputs
- a new `skills/<skill-name>/` folder as the canonical authoring target for transition work, using lowercase kebab-case
