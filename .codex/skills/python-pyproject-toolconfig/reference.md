...
```bash
uv run .codex/skills/python-pyproject-toolconfig/scripts/apply_toolconfig.py \
  --python-version 3.11 \
  --package-name mylib
```
...
```bash
uv run --python 3.13 .codex/skills/python-pyproject-toolconfig/scripts/apply_toolconfig.py --help
```
