...
| --- | --- | --- |
| Review an authored greenfield `blueprint.md` contract | Yes | No |
...
- the review request is really asking for authoring, approval of a skill folder, or execution
...
### Reroute to `python-project-init-greenfield`

Only after the blueprint review verdict is `approved`.
