...
| `git-branch-naming` | `skills/git-branch-naming/` | `materialized-copy` | `4e51dbd` | `materialized from canonical source by platform-projection-adapter; .codex/skills/... concretized; revalidated against canonical hygiene baseline at 4e51dbd` |
| `git-commit-convention` | `skills/git-commit-convention/` | `materialized-copy` | `4e51dbd` | `materialized from canonical source by platform-projection-adapter; .codex/skills/... concretized; revalidated against canonical hygiene baseline at 4e51dbd` |
