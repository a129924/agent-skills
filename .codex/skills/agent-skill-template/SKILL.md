...
4. Copy the folder shape and section layout for
   `.codex/skills/<skill-name>/`, while authoring the canonical source
...
16. If downstream planning-spine skills or other consumers still assume a
    platform-specific `.codex/skills/` surface, record that as a
...
# Outputs
- a copyable projected skill folder shape at `.codex/skills/<skill-name>/`
